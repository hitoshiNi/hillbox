<template>
  <div class="container">
    ...
    <div class="contents">
      <div class="content">
        <div class="robo_maru">
          <img src="../assets/robotR.png" class="robo">
        </div>
      ...
      <div class="content">
        <div class="robo_maru">
          <img src="../assets/robotG.png" class="robo">
        </div>
       <section class="detail_box">
         <div class="detail">
          <h1>デジタルマーケティング</h1>
          <p>〇LINEなどを活用したマーケティング施策のコンサルティングから開発、実行
            <br>〇公式アカウント、LINE BOT、運用広告など</p>
         </div>
       </section>
      </div>
      <div class="content">
        <div class="robo_maru">
          <img src="../assets/robotY.png" class="robo">
        </div>
       <section class="detail_box">
         <div class="detail">
          <h1>アプリ/WEBサービス開発</h1>
    ...
    <div class="links">
        <router-link to="/privacy" class="link_to_privacy"> ▷Privacy policy</router-link>
